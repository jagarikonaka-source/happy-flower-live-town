(function (global) {
  ...
  try { fullscreenWanted = global.localStorage.getItem('happy-flower-fullscreen-wanted') !== 'false'; } catch (_) {}
  ...
  function toggle() {
    ...
    try {
      ...
      if (fullscreen()) {
        ...
        try { global.localStorage.setItem('happy-flower-fullscreen-wanted', 'false'); } catch (_) {}
        const exit = doc.exitFullscreen || doc.webkitExitFullscreen;
        if (!exit) { fallback(); return; }
        result = exit.call(doc);
      } else {
        fullscreenWanted = true;
        try { global.localStorage.setItem('happy-flower-fullscreen-wanted', 'true'); } catch (_) {}
